...
export const metadata = {
  title: "Conditions d'Utilisation — Wassago",
};
    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="mt-8 flex flex-col gap-6 text-sm leading-relaxed text-ink-700">
        <section>
          ...
          <p>
            Wassago est une plateforme qui propose des services de marketing et de croissance pour
            réseaux sociaux (abonnés, vues, likes, commentaires, etc.). Wassago ne fournit pas ces
            services directement : chaque commande est transmise à un fournisseur technique tiers
            spécialisé, chargé de l&apos;exécution effective. Wassago agit comme intermédiaire entre
        ...
        <section>
          ...
          <p className="mt-2">
            Wassago ne garantit pas que les résultats obtenus (abonnés, vues, engagement, etc.)
            ...
            restreindre un compte. Wassago n&apos;a aucun contrôle sur ces décisions et ne peut en
        ...
        <section>
          ...
          <p>
            ...
            entièrement des capacités du fournisseur technique pour le service concerné : Wassago ne
            peut ni les garantir ni les créer pour un service qui ne les propose pas. Le support
            Wassago peut être contacté via la page de la commande ou le système de tickets pour toute
        ...
        <section>
          ...
          <p>
            ...
            concernée. Toute commande passée sur Wassago vaut acceptation explicite des présentes
            conditions et de la{" "}
        ...
        <section>
          ...
          <p>
            ...
            Wassago ne stocke aucune information bancaire ou de carte de paiement.
          </p>
        </section>
